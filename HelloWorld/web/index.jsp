         ...
         if (http_request.status == 200 || http_request.status==201) {
		  ...
		  //  result = result.replace(/([^-])\>/g, '$1&gt;');
            if (result === 'success'){
              ...
              document.getElementById('serverresponse').innerHTML = myObject.userid;
              document.getElementById('serverresponse2').innerHTML= myObject.name;
            }
         } else {
...
<form action="javascript:get(document.getElementById('myform'));" name="myform" id="myform">
  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td colspan="3"><input name="endpointURL" type="text" value="http://localhost:8080/HelloWorld/resources/ADD/USER" size="100"></td>
    </tr>
    <tr>
